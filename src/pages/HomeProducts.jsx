...
const HomeProducts = () => {
    ...
    return (
    <div style={{ marginLeft: "5%",marginBottom:"50px",marginTop:"50px" }}>
        <p style={{ fontSize: "45px", fontWeight: "300px" }}>Featured <span style={{ color: "pink",text:"bold" }}>Artworks</span></p>
