...
const SCart = ({ i, id, title, price, image, deleteCart, quantity, qtyIncreament, qtyDecreament }) => {

    // const [qty, setQty]=useState(1);

    return (
    <div style={{ width: "100%", display: "flex", border: "1px solid green", borderRadius: "10px", padding: "10px" }}>
